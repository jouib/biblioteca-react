...
function TabelaEmprestimo(): JSX.Element {
    ...
    const deletar = async (emprestimo: EmprestimoDTO) => {
        const confirmar = window.confirm(`Tem certeza que deseja deletar o empréstimo do livro ${emprestimo.livro.titulo} para o aluno ${emprestimo.aluno.nome}?`);
        ...
        if(confirmar && typeof emprestimo.idEmprestimo === 'number') {
            ...
            if(removido) {
                ...
                alert('Erro ao deletar o empréstimo.');
            }
        }
    }
